...
| UI governance evidence：governance domain、collection method、validation mechanism、evidence class、severity、project-local design-system policy、visual / AI review scope | [`ui-governance.md`](ui-governance.md)、[`templates/ui-governance-evidence-template.md`](templates/ui-governance-evidence-template.md) 和專案 review / validation artifacts |
...
- 對 UI compliance claim，能反查 UI governance domain、collection method、validation mechanism、evidence class、severity、project-local design-system policy 與 visual / AI review scope；不要把 browser review、visual diff 或 AI review 當成 governance domain 本身。
