...
| [`ui-governance.md`](ui-governance.md) | `plans/archived/2026-06-08-1408-ui-governance-workflow.md` Phase 1 | Focused execution surface：UI governance domains、validation mechanisms、evidence classes、severity policy、project-local design system boundary |
