...
見 [`intelligence/engineering/apk-analysis/heuristics/javascript-bitwise-64bit-truncation.md`](../heuristics/javascript-bitwise-64bit-truncation.md) — 包含正確的 `untagHeapPtr` 實作、`NativePointer` API 用法、以及決策表。
...
- [`intelligence/engineering/apk-analysis/heuristics/javascript-bitwise-64bit-truncation.md`](../heuristics/javascript-bitwise-64bit-truncation.md)（解法與預防規則）
