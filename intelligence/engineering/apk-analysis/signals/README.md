...
| [`media-type-detection.md`](media-type-detection.md) | 媒體類型偵測信號 — Magic Bytes 參考表、靜態 vs 動畫判斷、Container Probe 指令 | `skills/apk-analysis/techniques/media-hls/README.md` |
