...
涉及 Ai-skill framework / runtime / cognitive / architecture 共享詞彙時，**canonical source 是 [`knowledge/glossary/`](../../../../../knowledge/glossary/README.md)**，不在 requirements layer inline redefine。本文件只負責業務需求語言的對齊原則；framework 詞彙的判斷與形狀走 glossary entry schema + `ai-skill glossary validate`。詞義衝突依 glossary §Vocabulary Resolution Priority 解析。
