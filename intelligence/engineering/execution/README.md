# Execution Cognition Intelligence

本目錄保存 software delivery 執行推理、任務拆解、驗證推理與 recovery thinking。它不是 runtime state machine，而是 agent 在執行 delivery workflow 時的 cognition support。
