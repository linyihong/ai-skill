...
> **Cross-Domain Promotion**: Magic Bytes 參考表（MP4/WebP/GIF/PNG/JPEG/MP3/FLAC/TS/WebM）和靜態 vs 動畫判斷流程已提取到 [`intelligence/engineering/heuristics/magic-bytes-reference.md`](../../heuristics/magic-bytes-reference.md)，適用於任何需要判斷檔案類型的任務。
