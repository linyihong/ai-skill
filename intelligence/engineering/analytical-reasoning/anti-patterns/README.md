...
`intelligence/engineering/analytical-reasoning/anti-patterns/` 存放分析過程中常見的反模式與錯誤做法，主要源自 APK 分析領域。
...
- `intelligence/engineering/analytical-reasoning/failure/` 記錄具體失敗案例，本目錄記錄可預防的錯誤模式
