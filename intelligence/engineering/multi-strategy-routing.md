...
- [`intelligence/web-scraping/adaptive-parsing.md`](../web-scraping/adaptive-parsing.md) — Adaptive Parsing 作為解析策略之一
- [`intelligence/engineering/mcp-server-patterns.md`](mcp-server-patterns.md) — MCP Server 的 3-Layer 架構對應提取策略
