...
**Source**: 從 `intelligence/engineering/analytical-reasoning/heuristics/api-documentation-completeness.md` 提取的跨領域通用部分
...
- `intelligence/engineering/analytical-reasoning/heuristics/api-documentation-completeness.md`（領域特定版本，包含何時開始/完成 API Catalog 的決策表）
