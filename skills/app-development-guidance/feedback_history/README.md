...
| `common/2026-05-11_093100-public-mirror-drift-gate.md` | candidate | Public mirror drift gate | Check public SDK package drift before overwriting public runtime/docs from private source. |
| `common/2026-05-11_093200-session-login-concurrency-matrix.md` | candidate | Session login concurrency matrix | Test per-device session reuse, login/refresh single-flight, waiting requests, and rate-limit behavior. |
