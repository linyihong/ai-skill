...
| `common/2026-05-07_152100-private-live-adapter-smoke-gate.md` | candidate | Private live adapter smoke gate | Live-facing SDK/client work needs a private adapter smoke checklist when public analysis docs redact service, session, signing, or decrypt material. |
