...
Validation should distinguish "old behavior remains guarded" from "new code is proven". Prefer BDD/TDD plus changed-code tests; add mutation, property-based, contract, or database-backed tests when examples alone do not prove the rule.
