...
| File | When to use |
| --- | --- |
| [`initial-development-docs.md`](initial-development-docs.md) | Starting from a product brief, unclear requirements, or implemented-first backfill; drafts Product Brief, Contract Governance, Bounded Contexts, BDD, Domain Model, Architecture, API / Interface, Vendor Integration, Hardware / Firmware, Error Handling, Test Plan, and Implementation Slices. |
