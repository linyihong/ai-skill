...
Use these templates when turning app analysis, product intent, or review findings into reusable development documents.

| File | When to use |
| --- | --- |
| [`initial-development-docs.md`](initial-development-docs.md) | Starting from a product brief or unclear requirements; drafts Product Brief, Bounded Contexts, BDD, Domain Model, Architecture, API / Interface, Hardware / Firmware, Error Handling, Test Plan, and Implementation Slices. |
