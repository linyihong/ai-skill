...
| Do not use for | 不可取代 `skills/apk-analysis/SKILL.md`、`WORKFLOW.md`、授權確認或完整 dependency reads。 |
| Validation signal | Intelligence atom 連回 feedback lesson 與 `WORKFLOW.md` § `2. 選擇主線`；runtime registry 有對應 route。 |
