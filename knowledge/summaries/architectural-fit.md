## intelligence.architectural-fit

| 欄位 | 值 |
| --- | --- |
| Atom ID | `intelligence.architectural-fit` |
| Source path | `intelligence/engineering/architecture/architectural-fit/README.md` |
| Lifecycle | `candidate` |
...
| Do not use for | 不可取代完整的 `workflow/software-delivery/architecture/`、`intelligence/engineering/architecture/domain-modeling/` 或 governance gate。不可把 DDD 當預設架構。 |
