...
| [`apk-analysis-pilot.yaml`](apk-analysis-pilot.yaml) | 連接舊 `skills/apk-analysis/` 入口（已刪除）與 analysis / workflow / intelligence 目的地。 | `candidate` |
...
| [`requirements-cognition.yaml`](requirements-cognition.yaml) | 連接 requirements cognition、BDD-lite workflow、behavior governance metadata、software-delivery governance 與 validation scenarios。 | `candidate` |
| [`ddd-architecture-governance.yaml`](ddd-architecture-governance.yaml) | 連接 domain architecture cognition、architectural fit、software-delivery architecture workflow、governance、metadata 與 validation scenarios。 | `candidate` |
...
| [`workflow-software-delivery-architecture.yaml`](workflow-software-delivery-architecture.yaml) | 連接 software-delivery architecture workflow、architecture governance、domain architecture cognition、architectural fit、metadata 與 validation scenarios。 | `candidate` |
