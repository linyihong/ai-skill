...
`knowledge/indexes/` 負責讓 agent 從任務意圖快速找到 task-relevant knowledge。這裡保存索引格式與 routing table；不搬移既有 `skills/` 或 `shared-rules/` 內容。
...
| 執行 APK analysis execution flow | [`../../workflow/apk-analysis/execution-flow.md`](../../workflow/apk-analysis/execution-flow.md) | [`../../skills/apk-analysis/SKILL.md`](../../skills/apk-analysis/SKILL.md), [`../../skills/apk-analysis/WORKFLOW.md`](../../skills/apk-analysis/WORKFLOW.md), [`../../workflow/apk-analysis/artifact-gates.md`](../../workflow/apk-analysis/artifact-gates.md) | `workflow/` | 需要執行完整 APK analysis session（Quick Start、Default Workflow、capture windows、feedback loop）時 | 8-step Quick Start 可依序執行；reset baseline、capture window、feedback loop 各階段有明確完成定義 |
| 產出 APK analysis artifacts | [`../../workflow/apk-analysis/artifact-gates.md`](../../workflow/apk-analysis/artifact-gates.md) | [`../../skills/apk-analysis/DOCUMENTATION.md`](../../skills/apk-analysis/DOCUMENTATION.md), [`../../workflow/apk-analysis/execution-flow.md`](../../workflow/apk-analysis/execution-flow.md) | `workflow/` | 需要產出 UI Architecture Map、API Catalog、Domain/Runtime Baseline 或 Feature Reconstruction Handoff 時 | 各 artifact gate 有 minimum requirements table；evidence chain 與 failure recording 已檢查 |
| 執行 APK traffic triage / 選擇分析路線 | [`../../analysis/apk/traffic-triage.md`](../../analysis/apk/traffic-triage.md) | [`../../analysis/apk/tools-and-failures.md`](../../analysis/apk/tools-and-failures.md), [`../../skills/apk-analysis/WORKFLOW.md`](../../skills/apk-analysis/WORKFLOW.md), [`../../skills/apk-analysis/TOOLS.md`](../../skills/apk-analysis/TOOLS.md) | `analysis/` | 需要判斷流量在哪一層、選擇主線、找 hook 點、處理 Flutter/Dart AOT、MITM/proxy、response decoding、session/token 或 media/HLS 時 | Core triage decision tree 可依 evidence 選擇 route；high-semantic hook priority 已定義 |
| 查詢 APK 分析工具與失敗判讀 | [`../../analysis/apk/tools-and-failures.md`](../../analysis/apk/tools-and-failures.md) | [`../../analysis/apk/traffic-triage.md`](../../analysis/apk/traffic-triage.md), [`../../skills/apk-analysis/TOOLS.md`](../../skills/apk-analysis/TOOLS.md) | `analysis/` | 需要選擇工具、解讀常見失敗、執行 Frida health check 或使用命令模板時 | 5 類工具表、16 種失敗判讀、4 項工具選擇原則可反查 |
| 套用 APK analysis 工程智慧 | [`../../intelligence/engineering/apk-analysis/evidence-first-routing.md`](../../intelligence/engineering/apk-analysis/evidence-first-routing.md) | [`../../intelligence/engineering/apk-analysis/live-readiness-gates.md`](../../intelligence/engineering/apk-analysis/live-readiness-gates.md), [`../../intelligence/engineering/apk-analysis/README.md`](../../intelligence/engineering/apk-analysis/README.md), [`../../skills/apk-analysis/DOCUMENTATION.md`](../../skills/apk-analysis/DOCUMENTATION.md) | `intelligence/` | 需要 evidence-driven route selection、判斷 live SDK/client readiness 或 identity material self-generation audit 時 | 5-row evidence→route decision table 與 9-factor readiness table 可反查；status 為 validated-intelligence |
