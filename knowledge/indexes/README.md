...
| 決定 runtime context loading 路線 | [`../../runtime/routing/README.md`](../../runtime/routing/README.md) | [`../../metadata/ranking/README.md`](../../metadata/ranking/README.md), [`../../metadata/confidence/README.md`](../../metadata/confidence/README.md), [`../../knowledge/summaries/README.md`](../../knowledge/summaries/README.md) | `runtime/`, `knowledge/`, `metadata/` | 需要從 task intent 選擇 primary source、related sources 或 candidate summaries 時 | Primary source, deferred sources, source-of-truth gate, and validation signal are recorded |
