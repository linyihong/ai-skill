...
| `governance.repo-maintenance` | `validated` | [`repo-governance.md`](../summaries/repo-governance.md) | AI-native Cognitive Execution System 本身的維護、升級、遷移與治理。涵蓋 lifecycle management、validation、cleanup、splitting rules、dependency maintenance。 |
