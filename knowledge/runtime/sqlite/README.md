...
SQLite row 可以索引 feedback lessons，但 feedback lesson 全文仍留在 `feedback/history/<domain>/`。Agent 查詢 SQLite 後，只能把結果當作 candidate list；需要執行、修改或高信心判斷時，仍需讀 canonical source。
