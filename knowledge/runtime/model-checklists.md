...
| `route.intelligence.apk-analysis.atoms` | Primary: `intelligence/engineering/analysis/README.md`<br>Compression: `summary-first`<br>Required: `skills/apk-analysis/SKILL.md`<br>`analysis/apk/README.md`<br>Validation: 各 atom 有明確決策表或信號表，可反查驗證。 |
