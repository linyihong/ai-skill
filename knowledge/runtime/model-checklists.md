...
| `route.runtime.decision-recording` | Primary: `runtime/runtime.db`<br>Compression: `source-backed`<br>Required: `runtime/README.md`<br>`decisions/README.md`<br>Validation: 本輪若有鎖定決策，對應 tier 的檔案與 README 索引已更新。 |
