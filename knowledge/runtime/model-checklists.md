...
| `route.runtime.recovery` | Primary: `runtime/compiler/embedded_data.rb`<br>Compression: `source-backed`<br>Required: `runtime/compiler/embedded_data.rb`<br>`runtime/compiler/embedded_data.rb`<br>Validation: 阻斷 gate 已對應到 strategy，repair steps 已執行，verify steps 已通過。 |
...
| `route.runtime.context-ttl-doc` | Primary: `runtime/context/`<br>Compression: `index-only`<br>Required: `runtime/compiler/embedded_data.rb`<br>Validation: TTL policy 已套用，prune strategy 已理解。 |
...
| `route.governance.knowledge-update-flow` | Primary: `governance/lifecycle/knowledge-update-flow.md`<br>Compression: `source-backed`<br>Required: `runtime/compiler/embedded_data.rb`<br>`runtime/compiler/embedded_data.rb`<br>`runtime/compiler/embedded_data.rb`<br>Validation: 目前 knowledge update 的步驟已確認，entry conditions 已滿足，exit conditions 已檢查，reference sources 已載入，下一步驟已決定。  |
...
| Route | Checklist |
| --- | --- |
| `route.workflow.apk-analysis` | Primary: `workflow/apk-analysis/execution-flow.md`<br>Compression: `source-backed`<br>Required: `workflow/apk-analysis/artifact-gates.md`<br>`enforcement/README.md`<br>`enforcement/dependency-reading.md`<br>Validation: 新分層路徑可讀取，workflow 與 analysis 內容已分離。 |
...
| `route.workflow.software-delivery` | Primary: `workflow/software-delivery/execution-flow.md`<br>Compression: `source-backed`<br>Required: `workflow/software-delivery/artifact-gates.md`<br>`enforcement/README.md`<br>Validation: 新分層路徑可讀取，workflow 與 analysis 內容已分離。 |
...
| `route.intelligence.apk-analysis.atoms` | Primary: `intelligence/engineering/analytical-reasoning/README.md`<br>Compression: `summary-first`<br>Required: `workflow/apk-analysis/execution-flow.md`<br>`analysis/apk/README.md`<br>Validation: 各 atom 有明確決策表或信號表，可反查驗證。 |
