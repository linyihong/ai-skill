...
1. **架構級**已升級為 [ADR-006](../../constitution/ADR-006-registry-first-workflow-activation.md)（registry-first workflow activation）。
...
- 新 session agent 應先查 `constitution/README.md` §錯誤查詢索引 或 `decision-recording.yaml` lookup。
- 僅寫在 plan 內文、未進 decisions 的鎖定項視為 **未閉環**。

## Related

- [ADR-006](../../constitution/ADR-006-registry-first-workflow-activation.md)
