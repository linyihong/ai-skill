...
- [ ] **Generated YAML 重新編譯**：執行 `ruby runtime/compiler/compiler-engine.rb` 重新編譯
- [ ] **phase-machine.yaml**：如有 phase 變更，是否同步更新？
- [ ] **obligation-ledger.yaml**：如有 obligation 變更，是否同步更新？
- [ ] **blocking-gates.yaml**：如有 gate 變更，是否同步更新？
...
### Runtime Surface
- [ ] compiler 已執行
- [ ] phase-machine.yaml 已同步
- [ ] obligation-ledger.yaml 已同步
- [ ] blocking-gates.yaml 已同步
