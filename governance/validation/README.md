...
| SQLite runtime index boundary | 確認 SQLite / FTS 只作 generated lookup cache，DB 可重建且不取代 canonical source。 | SQLite generator、query helper、feedback lesson index 或 runtime lookup cache 變更。 |
