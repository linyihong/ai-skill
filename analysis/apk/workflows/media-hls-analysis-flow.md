...
`analysis/apk/workflows/media-hls-analysis-flow.md` 是從 `skills/apk-analysis/techniques/media-hls/` 拆解出的 **HOW TO DO** 操作流程。決策智慧（媒體類型判斷信號）請見 `intelligence/engineering/apk-analysis/signals/media-type-detection.md`。
