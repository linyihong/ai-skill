...
`analysis/apk/workflows/http-api-documentation-flow.md` 是從 `skills/apk-analysis/techniques/http-api/` 拆解出的 **HOW TO DO** 操作流程。決策智慧（何時該開始、何時該停、欄位信心判斷）請見 `intelligence/engineering/apk-analysis/heuristics/api-documentation-completeness.md`。
