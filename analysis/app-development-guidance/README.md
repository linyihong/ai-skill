...
領域分類索引已移至 [`metadata/app-development-guidance/`](../../metadata/app-development-guidance/)：

| Catalog | 說明 |
|---------|------|
| [`controls-catalog.md`](../../metadata/app-development-guidance/controls-catalog.md) | 跨平台安全控制類型與核心原則 |
| [`implementation-catalog.md`](../../metadata/app-development-guidance/implementation-catalog.md) | 實作模式分類與 contract-to-implementation 映射流程 |
...
3. 需要分類索引參考時讀 `metadata/app-development-guidance/` 下的 catalog。
