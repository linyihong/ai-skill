...
- Complements [`active/2026-06-12-1600-projection-break-evidence-taxonomy-experience-runtime.md`](2026-06-12-1600-projection-break-evidence-taxonomy-experience-runtime.md): that plan owns L3 `evidence_type` catalog + gate vocabulary; this plan owns journey / experience-validation pipeline execution — do not collapse `collection_method` into `evidence_type`.
