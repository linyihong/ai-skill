...
| Intent stability、claim scope、contradiction propagation、belief ownership、minimality、cognitive cost 的治理 gate | `governance/ai-runtime-governance/cognitive-state-governance.md` | 不取代 workflow success criteria；不讓 governance 遞迴膨脹。 |
...
### 5.17 Source Freshness and Validity Governance
...
- [ ] 定義 assumption lifecycle、assumption ledger、belief ownership、evidence lineage、contradiction propagation、evidence qualification、confidence integrity、temporal decay、claim scope、intent stability、cognitive state model、cognitive contamination、belief GC、governance minimality / cognitive cost 的治理 gate。
...
- 至少十個 failure-derived scenario 驗證 assumption drift、evidence qualification override、belief ownership conflict、confidence integrity、claim scope overcompression、intent drift、contradiction propagation、recovery exit、re-entry safety、cognitive contamination / governance recursion。
