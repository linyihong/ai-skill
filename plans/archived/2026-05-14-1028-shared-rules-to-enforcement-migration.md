...
**architecture/:**
- [ ] 更新 `plans/archived/2026-05-11-1112-next-stage-upgrade-plan.md`（若有 shared-rules 引用）
- [ ] 更新 `plans/archived/2026-05-11-1129-apk-analysis-pilot-migration.md`（若有 shared-rules 引用）
