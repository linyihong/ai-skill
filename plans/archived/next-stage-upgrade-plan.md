...
| 32g | 更新 `runtime/onboarding/README.md` + `plans/archived/next-stage-upgrade-plan.md` | ✅ |
| 32h | 提交 + push | ✅ |
...
| 33e | 更新 `plans/archived/next-stage-upgrade-plan.md` | ✅ |
| 33f | 提交 + push | ✅ |
...
| --- | --- | --- | --- | --- | --- |
| P1 | done | 建立 next-stage upgrade plan | `plans/archived/next-stage-upgrade-plan.md` | 已完成 | 規劃書 commit/push/readback，root/architecture 入口可找到 |
