...
| [`active/2026-05-28-1200-gen3-runtime-trigger-audit-and-completion.md`](active/2026-05-28-1200-gen3-runtime-trigger-audit-and-completion.md) | draft | Gen 3 Runtime Trigger Audit & Completion：對 57 routes / 73 generated_surfaces / 44 scenarios 做 4-way 分類（auto-detected / consumed / intentionally manual / orphan）；落地 `ai-skill runtime audit` 與 `validateRuntimeTriggerWiring`（第 16 個 commit-msg validator）；補 wire ≥ 5 個 high-priority orphans；加 `pre_2026_05_28_doc_only_completion` grandfather flag；新增 warning-only glossary coverage guardrail，避免 `plans/active`、`architecture`、`workflow`、`analysis`、`intelligence` 等層新增框架詞彙但未回寫 glossary。**Sequencing：排在 economics integration plan 之前**。 |
...
| [`archived/2026-05-20-1745-memory-retrieval-activation-governance.md`](archived/2026-05-20-1745-memory-retrieval-activation-governance.md) | ✅ completed / archived | Memory Retrieval & Activation Governance — selective cognitive replay system、retrieval / activation / replay cost、freshness、contamination boundary、working-memory buffer、promotion pipeline、routing / graph / validation surfaces 已完成 |
| [`archived/2026-05-20-1802-model-aware-execution-routing.md`](archived/2026-05-20-1802-model-aware-execution-routing.md) | ✅ completed / archived | Model-Aware Execution Routing — execution strategy layer、capability dimensions、workflow adaptation、model selection governance、runtime primitives、routing registry 與 validation scenarios 已完成 |
