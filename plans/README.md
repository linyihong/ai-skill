...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-05-26-1039-landing-page-positioning-refresh.md`](active/2026-05-26-1039-landing-page-positioning-refresh.md) | draft | Landing Page Positioning Refresh：將根 README 從內部 bootstrap / OS layout 入口重構為 public-facing landing page，先呈現中英標語、What / Why / Why Different；agent bootstrap 只保留最短入口，contract 細節回到 `CORE_BOOTSTRAP.md` / `runtime/core-bootstrap.yaml` |
