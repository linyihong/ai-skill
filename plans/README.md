...
| [`active/2026-05-21-0834-cross-platform-go-script-runtime.md`](active/2026-05-21-0834-cross-platform-go-script-runtime.md) | 📝 draft | Cross-Platform Go Script Runtime — 將 scripts 層升級為 Windows、macOS、Linux 可執行的單一 Go binary / runtime toolchain，優先內建 pure Go SQLite（`modernc.org/sqlite` candidate）、YAML、JSON 與 runtime logic；iOS 以 App sandbox、Browser/WASM、SSH remote runner / control plane 評估，明確不支援 native arbitrary binary |
