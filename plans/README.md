...
| [`active/2026-05-20-1501-cognitive-state-evidence-governance.md`](active/2026-05-20-1501-cognitive-state-evidence-governance.md) | 📝 draft | Cognitive State & Evidence Governance — ephemeral belief、evidence qualification、confidence integrity、claim scope、cognitive contamination 與 human alignment threshold 補強計畫 |
