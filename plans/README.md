...
| [`active/2026-06-09-1040-experience-validation-pipeline-evolution.md`](active/2026-06-09-1040-experience-validation-pipeline-evolution.md) | draft | Experience Validation Pipeline Evolution：記錄 responsive render-context governance 後續 open questions；優先處理 Browser Evidence Metadata 與 evidence-scoped Capture Envelope ownership，其次觀察可能升 shared Validation Reasoning 的 State / Context / Evidence Coverage；短期保留 `Responsive` domain，watch typed Context Taxonomy 與 matrix explosion 控制，不立即新增 runtime gate。 |
