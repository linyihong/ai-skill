...
| [`active/2026-06-08-1047-feedback-learning-report-obligation.md`](active/2026-06-08-1047-feedback-learning-report-obligation.md) | draft | Feedback / Learning Report Obligation：新增 final close-out learning decision report，要求 agent 像 Cognitive block 一樣回報是否需要沉澱 reusable feedback；non-local / close-loop limited context 至少回報 CHECK。 |
