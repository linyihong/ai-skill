...
| [`active/2026-05-21-0834-cross-platform-go-script-runtime.md`](active/2026-05-21-0834-cross-platform-go-script-runtime.md) | 🚧 in-progress | Cross-Platform Go Script Runtime — 將 scripts 層升級為 Windows、macOS、Linux 可執行的單一 Go binary / runtime toolchain；`scripts/ai-skill-cli/docs/` 放文件先行 artifacts，未來程式碼放同一專案根目錄下的 `cmd/` / `internal/` / `testdata/`；desktop Git 作為 external dependency，iOS 以 App sandbox、Browser/WASM、SSH remote runner / control plane 評估 |
