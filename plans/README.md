...
| [`active/2026-06-12-1600-projection-break-evidence-taxonomy-experience-runtime.md`](active/2026-06-12-1600-projection-break-evidence-taxonomy-experience-runtime.md) | draft | Projection Break → Evidence Taxonomy → Experience Runtime：L3=Validation Capability、三分 taxonomy、authority layer、cross-cutting experience-runtime；downstream immersive player preview gate incident 為 pilot。 |
