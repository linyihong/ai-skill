...
| [`active/2026-05-20-1501-cognitive-state-evidence-governance.md`](active/2026-05-20-1501-cognitive-state-evidence-governance.md) | 📝 draft | Cognitive State & Evidence Governance — tier boundary、minimal runtime principle、meta-stop rule、belief ownership、autonomy modes 與 recovery re-entry safety 補強計畫 |
