...
| [`active/2026-06-10-0908-user-journey-validation-integration.md`](active/2026-06-10-0908-user-journey-validation-integration.md) | in-progress | User Journey Validation Integration：Phase 0–5 first landing 已落地；BDD 擁有 Journey Specification，validation workflow 負責 Journey Execution；criticality selection criteria、`validation_scope`、`expected_outcomes` / `observable_evidence`、workflow gates、artifact gates、glossary terms 與 4 個 validation scenarios 已補，後續觀察是否 archive 或 promotion 到 shared Validation Reasoning。 |
