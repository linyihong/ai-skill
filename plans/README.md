...
| [`active/2026-05-20-1501-cognitive-state-evidence-governance.md`](active/2026-05-20-1501-cognitive-state-evidence-governance.md) | 📝 draft | Cognitive State & Evidence Governance — ephemeral belief、evidence qualification、intent stability、autonomy modes、contradiction propagation、recovery exit 與 cognitive cost governance 補強計畫 |
