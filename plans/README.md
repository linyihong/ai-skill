...
| [`active/shared-rules-to-enforcement-migration.md`](active/shared-rules-to-enforcement-migration.md) | 📄 draft | enforcement/ → enforcement/ 搬遷計畫，含 Layer Responsibility Contract |
