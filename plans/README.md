...
| [`active/2026-06-10-0908-user-journey-validation-integration.md`](active/2026-06-10-0908-user-journey-validation-integration.md) | draft | User Journey Validation Integration：規劃把 critical user journey 作為 Outcome Validation 能力落地；BDD 擁有 Journey Specification，validation workflow 負責 Journey Execution；journeys 由 project-defined 且需 criticality selection criteria；Journey 不進 `validation_domain`，Phase 0 判斷它應是 `journey_coverage` 還是 `validation_scope`，並拆分 `expected_outcomes` / `observable_evidence`。 |
