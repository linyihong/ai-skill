...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-05-22-0855-executable-yaml-contract-migration.md`](active/2026-05-22-0855-executable-yaml-contract-migration.md) | draft | Executable YAML Contract Migration：盤點哪些流程、gate、required reads、failure actions 應升級為 owner-layer YAML contract，並投影到 runtime generated surfaces，降低非 ChatGPT agent 漏跑流程的風險 |
