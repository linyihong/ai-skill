...
| [`active/2026-05-20-1745-memory-retrieval-activation-governance.md`](active/2026-05-20-1745-memory-retrieval-activation-governance.md) | 🔄 in-progress | Memory Retrieval & Activation Governance — Phase 0-2 已完成；將 memory/ 從 storage taxonomy 升級為 selective cognitive replay system，補足 retrieval、activation、replay cost、freshness、contamination boundary、working-memory buffer 與 promotion pipeline |
