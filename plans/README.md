...
| [`active/2026-05-20-1501-cognitive-state-evidence-governance.md`](active/2026-05-20-1501-cognitive-state-evidence-governance.md) | 📝 draft | Cognitive State & Evidence Governance — governance minimality、belief ownership、autonomy modes、contradiction propagation、recovery re-entry safety 與 cognitive state model 補強計畫 |
