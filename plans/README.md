...
| [`active/2026-06-08-1544-evidence-acquisition-layer.md`](active/2026-06-08-1544-evidence-acquisition-layer.md) | draft | Evidence Acquisition Layer for Validation Taxonomy：補上 `collection_method` 作為 evidence acquisition layer，讓 Browser Review、contract readback、static analysis、runtime trace 與 human observation 有明確 owner；first landing 限於 workflow taxonomy + validation scenarios，不新增 `sd-browser-review`、runtime YAML 或 enforcement rule_class。 |
