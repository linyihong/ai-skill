...
| [`active/2026-06-08-1047-feedback-learning-report-obligation.md`](active/2026-06-08-1047-feedback-learning-report-obligation.md) | draft | Feedback / Learning Report Obligation：新增 final close-out learning disposition report，拆成 `feedback_decision` / `repo_context` / `writeback_status` / `learning_type` 四維；hook 只驗 presence/schema/enums，commit message 不強制。 |
