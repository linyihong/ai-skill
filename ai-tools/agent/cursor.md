...
- Project-specific rule bodies should live in `<PROJECT_ROOT>/.ai-skill/project/rules/`; `.cursor/rules/*.mdc` should be thin pointers to those files so non-Cursor tools can load the same overlay.
