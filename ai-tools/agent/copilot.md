...
- Copilot 新 session 若沒有可靠讀取 bootstrap，使用 `ai-skill copilot start --project <project>` 或 project-local `.copilot/start-copilot.sh` 產生第一則 guided bootstrap prompt，貼給 Copilot 後再開始任務。
