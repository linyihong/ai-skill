    ...
    "core_rules": [
      {
        ...
        "exceptions": [
          ...
          "翻譯後會降低精準度的專有名詞（如 \"AI-native Knowledge Operating System\"、\"reference-first\"）",
  ...
  OUTPUT_GOVERNANCE_OUTPUT_RULES =   {
    ...
    "format_rules": [
      ...
      },
      {
        ...
        "rule": "下列內容可保留英文：檔名、路徑、命令、環境變數、程式符號、 API 欄位、固定 protocol 名稱、工具名稱，以及翻譯後會降低精準度的 專有名詞（如 \"AI-native Knowledge Operating System\"、\"reference-first\"、 \"Default Bootstrap\"、\"rule-weight\"、\"source-of-truth\"）。\n",
        "applies_to": [
          "all_documents"
        ],
        "canonical_source": "enforcement/neutral-language.md"
