...
> **遷移狀態**：此文件為新分層的 reference target，`skills/apk-analysis/SKILL.md` 已不再作為 active entrypoint。新內容請直接寫入此文件。
...
- `skills/apk-analysis/SKILL.md` 是原始來源，已不再作為 active entrypoint。
