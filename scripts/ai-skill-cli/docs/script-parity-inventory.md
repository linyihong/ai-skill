...
| Runtime query | keyword、filter、limit、empty result、missing DB 行為穩定 | `ai-skill runtime query` | query fixture、empty result fixture（SQLite runtime index native slice 已覆蓋；knowledge graph query 待補） |
