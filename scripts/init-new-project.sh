...
邊界參考：[\`${AI_SKILL_REPO}/enforcement/tool-neutral-documentation.md\`](${AI_SKILL_REPO}/enforcement/tool-neutral-documentation.md)；拆分與篇幅：[\`${AI_SKILL_REPO}/governance/document-sizing.md\`](${AI_SKILL_REPO}/governance/document-sizing.md)。
