...
| Cursor | `.cursor/hooks.json` | sessionStart bootstrap prompt + stop close-out hook；stop hook 委派 repo-local `ai-skill hooks run stop`，缺 final Cognitive Mode 報告時 fail closed / loop back |
