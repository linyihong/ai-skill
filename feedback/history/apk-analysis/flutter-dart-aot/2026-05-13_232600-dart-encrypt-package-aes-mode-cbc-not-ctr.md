...
- Evidence path: `<PROJECT_ROOT>/<target-app>/docs/eh-header-generation-status-2026-05-13.md`
...
- `intelligence/engineering/analytical-reasoning/heuristics/` — 新增 heuristic：「Dart encrypt package mode detection」
