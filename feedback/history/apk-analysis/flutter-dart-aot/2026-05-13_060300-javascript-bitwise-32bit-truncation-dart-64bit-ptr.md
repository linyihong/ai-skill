...
#### Promotion Target
- `intelligence/engineering/apk-analysis/heuristics/javascript-bitwise-64bit-truncation.md`（已 promote）

#### Required Linked Updates
- `feedback/history/apk-analysis/README.md`：`flutter-dart-aot/` 計數從 13 → 14（已更新）
- `intelligence/engineering/apk-analysis/heuristics/README.md`：新增 atom 列（已更新）
