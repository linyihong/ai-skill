...
| `dynamic-capture/2026-05-19_143500-avoid-single-cached-target-for-decrypt-capture.md` | validated | Avoid single cached target for decrypt capture | 🔄 | `analysis/apk/workflows/frida-hook-flow.md`; workflow layer checked, no direct update needed |
