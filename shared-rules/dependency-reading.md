...
| `shared-rules/rule-weight.md` | `shared-rules/README.md`、`shared-rules/content-layering.md`、`shared-rules/linked-updates.md`、`shared-rules/dependency-reading.md`、`shared-rules/decision-efficiency.md`、`shared-rules/goal-action-validation.md`、工具專用 always-apply agent rule、`ai-tools/` bootstrap 清單。 |
| `shared-rules/decision-efficiency.md` | `shared-rules/README.md`、`shared-rules/content-layering.md`、`shared-rules/linked-updates.md`、`shared-rules/dependency-reading.md`、`governance/document-sizing.md`、相關 skill 的 workflow / tools / README（若該 skill 有決策路由或 context-loading 指引）。 |
| `shared-rules/failure-learning-system.md` 或 `shared-rules/failure-patterns/` | `shared-rules/README.md`、`shared-rules/content-layering.md`、`shared-rules/linked-updates.md`、`shared-rules/reusable-guidance-boundary.md`、`shared-rules/feedback-lessons.md`、`shared-rules/goal-action-validation.md`、`shared-rules/dependency-reading.md`、相關 tool 文件與被補強的 shared rule / skill workflow。 |
...
- 再用 `failure-learning-system.md` 分類失效模式、選擇 promotion target，必要時新增或更新 `shared-rules/failure-patterns/`。
- 若失效模式是 skill-specific，將 lesson 放到該 skill 的 `feedback_history/`；若是 cross-skill 或全庫行為，放到 `shared-rules/failure-patterns/` 或對應 shared rule。
