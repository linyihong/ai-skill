...
| [Commit/push before Step 10 validation skip](commit-before-validation-skip.md) | `validation-gap` | candidate | 防止 agent 在 commit/push 前跳過 knowledge-update-flow Step 10 的完整驗證檢查清單。 |
