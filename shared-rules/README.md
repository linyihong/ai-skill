...
| 7 | [document-todo-list.md](document-todo-list.md) | 文件前段 TODO 表與 goal/章節連結。 |
| 8 | [document-sizing.md](document-sizing.md) | 文件大小、拆分時機、資料夾與索引結構。 |
| 9 | [goal-action-validation.md](goal-action-validation.md) | 重要工作單元的目標、執行、驗證。 |
| 10 | [neutral-language.md](neutral-language.md) | 文件標題、摘要與正文的中性低爭議用語。 |
