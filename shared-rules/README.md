...
| VS Code Extension 全域設定修改 | [vscode-extension-global-state.md](../intelligence/engineering/ide/vscode-extension-global-state.md) | VS Code Extension 的全域設定儲存在 SQLite 資料庫中，修改方法與注意事項。此為可重複使用的工程智慧，非工具設定。 | lazy (P2) |
