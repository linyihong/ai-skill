...
| 工具同步 / 參照 | [tool-neutral-documentation.md](tool-neutral-documentation.md) / [`ai-tools`](../ai-tools/README.md) | 通用規則保持工具中立；具體工具參照、symlink、同步、hook、UI 與路徑放在 `ai-tools/` 或工具設定檔。 | lazy (P2) |
