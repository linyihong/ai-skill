...
| 全庫**錯誤學習系統**（將 agent 錯誤分類、記錄、推廣成防呆規則與 validation gate） | **[`error-learning-system.md`](error-learning-system.md)**（流程正文）；可重用跨 skill 錯誤模式放 **[`error-patterns/`](error-patterns/README.md)** |
