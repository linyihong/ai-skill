...
| 新增或修改 `skills/<name>/tool-adapters/<tool>.md` | 該 skill 的 `README.md` 或 adapter index、核心 `WORKFLOW.md`/`TOOLS.md` 中的 adapter link、`ai-tools/<tool>.md` 的 cross-link（若該工具已有集中說明）、必要 validation/checklist。 |
