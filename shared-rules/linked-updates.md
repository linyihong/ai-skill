...
| `shared-rules/decision-efficiency.md` | `shared-rules/README.md`、`shared-rules/content-layering.md`、`shared-rules/dependency-reading.md`、`shared-rules/linked-updates.md`、`shared-rules/document-sizing.md`、有決策路由/context-loading 指引的 skill workflow 或 README（`workflow/<domain>/` 或 `skills/<name>/`）。 |
...
| 新增或修改 `skills/<name>/tool-adapters/<tool>.md` 或 `tools/adapters/<tool>.md` | 該 skill 的入口（`skills/<name>/README.md` 或 `workflow/<domain>/README.md`）、核心 `execution-flow.md` 中的 adapter link、`ai-tools/<tool>.md` 的 cross-link（若該工具已有集中說明）、必要 validation/checklist。 |
...
| 新增 `feedback_history` lesson | 該 skill 的 `feedback_history/README.md`，必要時 `workflow/<domain>/`、`analysis/<domain>/` 或分類文件。 |
| 修改 `analysis/app-development-guidance/controls-catalog.md`（原 `skills/app-development-guidance/controls/`） | 相關 `analysis/app-development-guidance/implementation-catalog.md`、`analysis/app-development-guidance/platforms-catalog.md`、`analysis/app-development-guidance/languages-catalog.md`、`workflow/app-development-guidance/development-process.md`。 |
| 修改 `workflow/app-development-guidance/development-process.md`（原 `skills/app-development-guidance/process/`） | 相關 `workflow/app-development-guidance/artifact-gates.md`、`analysis/app-development-guidance/risk-translation.md`、`analysis/app-development-guidance/implementation-catalog.md`、`workflow/app-development-guidance/execution-flow.md`。 |
| 修改 `analysis/app-development-guidance/implementation-catalog.md`（原 `skills/app-development-guidance/implementation/`） | 相關 `analysis/app-development-guidance/controls-catalog.md`、`analysis/app-development-guidance/platforms-catalog.md`、`analysis/app-development-guidance/languages-catalog.md`。 |
| 修改 `analysis/app-development-guidance/` 的 templates（原 `skills/app-development-guidance/templates/`） | `workflow/app-development-guidance/artifact-gates.md`、`workflow/app-development-guidance/development-process.md`、`workflow/app-development-guidance/execution-flow.md` 與引用該模板的文件。 |
| 修改 `workflow/app-development-guidance/development-process.md` 的 Product Brief / 企劃書驗證規則 | `workflow/app-development-guidance/development-process.md`、`workflow/app-development-guidance/execution-flow.md`、`workflow/app-development-guidance/artifact-gates.md`、`analysis/app-development-guidance/README.md`。 |
| 修改 `analysis/app-development-guidance/platforms-catalog.md` 或 `analysis/app-development-guidance/implementation-catalog.md` 的 embedded 相關內容 | `workflow/app-development-guidance/development-process.md`、`workflow/app-development-guidance/execution-flow.md`、`workflow/app-development-guidance/artifact-gates.md`。 |
| 修改 `analysis/app-development-guidance/implementation-catalog.md` 的 backend 相關內容 | `analysis/app-development-guidance/controls-catalog.md`、`workflow/app-development-guidance/development-process.md`、`workflow/app-development-guidance/execution-flow.md`。 |
| 修改 `analysis/app-development-guidance/` 的 tooling 相關內容 | `workflow/app-development-guidance/development-process.md`、`workflow/app-development-guidance/execution-flow.md`、`workflow/app-development-guidance/artifact-gates.md`。 |
| 修改 `workflow/app-development-guidance/development-process.md` 的 implemented-first governance / traceability / BDD closure 規則 | `workflow/app-development-guidance/development-process.md`、`workflow/app-development-guidance/execution-flow.md`、`workflow/app-development-guidance/artifact-gates.md`、`analysis/app-development-guidance/README.md`。 |
| | **架構重構**（目錄重組、分層新增、路徑變更、命名變更） | 依 [`governance/lifecycle/intelligence-extraction-pipeline.md`](../governance/lifecycle/intelligence-extraction-pipeline.md) Step 7a 檢查以下 shared-rules 檔案：`document-sizing.md`（範例路徑）、`linked-updates.md`（本檔表格）、`feedback-lessons.md`（Promotion Target 模板）、`shared-rules/README.md`（lazy-load 表格）、`skills/ADDING_SKILLS.md`（目錄結構建議）、`content-layering.md`（路徑描述）、`tool-neutral-documentation.md`（路徑描述）、`decision-efficiency.md`（Context Loading 步驟）、`cross-skill-references.md`（引用格式）。同時檢查 `failure-patterns/README.md` 索引與 `failure-learning-system.md` 的 Promotion Decision 表格。 |
