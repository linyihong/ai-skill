...
2. 讀取 `enforcement/failure-learning-system.md`、`../../../feedback/feedback-lessons.md`、`enforcement/reusable-guidance-boundary.md`、`enforcement/linked-updates.md` 與 `enforcement/failure-patterns/README.md`。
...
- `../../../feedback/feedback-lessons.md` 或 affected skill rule 明確提醒：agent mistake 或 close-loop gap 需走 failure-learning system。
