...
| Feedback 與技巧條目 | [feedback-lessons.md](feedback-lessons.md) | **檔名規則、模板、agent 行為、索引**（唯一正文）；lesson 目前位置 `feedback/history/<domain>/`（derived from `route.feedback.history`），舊 `skills/<name>/feedback_history/` 已於 2026-05-13 刪除。 | lazy (P2) |
